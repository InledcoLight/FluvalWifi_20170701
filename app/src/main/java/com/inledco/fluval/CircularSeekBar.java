...
public class CircularSeekBar extends View
{
     ...
     */
    @SuppressWarnings ( "unused" ) private float ccwDistanceFromEnd;
    ...
    private void initAttributes ( TypedArray attrArray )
    {
        ...
        mPointerHaloBorderWidth = (float) ( attrArray.getFloat( R.styleable.CircularSeekBar_pointer_halo_border_width, DEFAULT_POINTER_HALO_BORDER_WIDTH ) *
                                            DPTOPX_SCALE );
    ...
    protected void onDraw ( Canvas canvas )
    {
        ...
        {
            canvas.drawCircle( mPointerPositionXY[0],
    ...
    protected void onMeasure ( int widthMeasureSpec, int heightMeasureSpec )
    {
        ...
        if ( mMaintainEqualCircle )
        { // Applies regardless of how the values were determined
