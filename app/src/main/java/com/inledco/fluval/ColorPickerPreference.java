...
public class ColorPickerPreference extends DialogPreference implements ColorPickerView.OnColorChangedListener
{
    ...
    private void init ( AttributeSet attrs )
    {
        ...
        colorPickerSliderColor = a.getColor( R.styleable.ColorPickerView_sliderColor, -1 );
        colorPickerBorderColor = a.getColor( R.styleable.ColorPickerView_borderColor, -1 );
    ...
    protected void onBindDialogView ( View layout )
    {
        ...
        {
            ( (LinearLayout) mOldColorView.getParent() ).setPadding( Math.round( mColorPickerView.getDrawingOffset() ),
                                                                     0,
